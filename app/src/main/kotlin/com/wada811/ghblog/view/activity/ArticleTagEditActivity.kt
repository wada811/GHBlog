...
class ArticleTagEditActivity : AppCompatActivity() {
    ...
    lateinit var binding: ArticleTagEditActivityBindingAdapter
    val subscriptions = CompositeSubscription()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ArticleTagEditActivityBindingAdapter(this, R.layout.activity_article_tag_edit)
        binding.viewModel = ArticleTagEditViewModel().addTo(subscriptions)
